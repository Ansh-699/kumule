/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: ef19f54c4a2c8b9ea8ef7f2d856f7444)
...
declare namespace Cloudflare {
	...
	interface Env {
		ENABLE_DIRECT_CRYPTO: "true";
		MINT_ASSET_SEED: string;
		MINT_VAULT_PRIVATE_KEY: string;
		NFT_IMAGES: R2Bucket;
	}
}
